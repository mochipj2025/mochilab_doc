...
const options = {
  contentType: ["漫画1コマ", "漫画3コマ", "縦スクロール漫画の1シーン", "雑誌表紙", "雑誌特集ページ", "note見出し画像", "SNSカルーセル1枚目", "キャラクター紹介ページ"],
  purpose: ["note記事の見出し画像", "SNS告知", "漫画の導入", "キャラクター紹介", "世界観紹介", "連載告知", "作品アーカイブ"],
  format: ["縦長 4:5", "正方形 1:1", "横長 16:9", "縦長 9:16", "A4縦", "雑誌見開き風"],
  mangaCut: ["導入の引きカット", "表情アップ", "手元のディテールカット", "後ろ姿の余韻カット", "会話前の沈黙カット", "場面転換カット", "決めゴマ", "小さなオチのカット"],
  magazineLayout: ["余白のある特集扉ページ", "静かなインタビューページ", "写真集の1ページ", "見出しが大きい雑誌表紙", "小さなキャプション入りページ", "図鑑風の紹介ページ", "コラム挿絵ページ"],
  composition: ["人物を右寄せ、左に余白", "中央に人物、周囲に大きな余白", "下部に人物、上部に見出し余白", "斜め構図", "画面端に小さく人物", "手元を大きく写す"],
...
function buildPrompt() {
  ...
  return [
    "以下の内容で、画像生成AI向けの日本語Promptを作る。",
    "",
    ...lines,
    "",
    "全体は静かな日本語編集デザインでまとめる。",
